    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(error_messages={'unique': 'Пользователь с таким номером телефона уже существует.'}, help_text='Номер телефона в формате +992XXYYYYYY.', max_length=13, unique=True, validators=[django.core.validators.RegexValidator(message="Номер телефона должен быть в формате: '+992XXYYYYYY'.", regex='^\\+992\\d{9}$')], verbose_name='phone number')),
                ('email', models.EmailField(blank=True, max_length=254, null=True, verbose_name='email address')),
                ('email_verified', models.BooleanField(default=False, help_text='Указывает, подтвержден ли email пользователя.', verbose_name='email verified')),
                ('first_name', models.CharField(max_length=150, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, max_length=150, verbose_name='last name')),
                ('middle_name', models.CharField(blank=True, default='', max_length=150, null=True, verbose_name='middle name')),
                ('date_of_birth', models.DateField(help_text='Дата рождения пользователя.', verbose_name='Дата рождения')),
                ('profile_picture', models.ImageField(blank=True, help_text='Фотография профиля', null=True, storage=storages.backends.s3.S3Storage(), upload_to='profile_pictures', verbose_name='profile picture')),
                ('gender', models.CharField(blank=True, choices=[('M', 'Мужской'), ('F', 'Женский')], help_text='Пол пользователя (необязательное).', max_length=1, null=True, verbose_name='gender')),
                ...
                ('city', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='map.city', verbose_name='Город проживания')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('subscription', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='subscriptions.subscription', verbose_name='Подписка')),
