    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('philosophy', models.TextField(blank=True, help_text='Краткое описание подхода к пациентам', verbose_name='Философия работы')),
                ('philosophy_ru', models.TextField(blank=True, help_text='Краткое описание подхода к пациентам', null=True, verbose_name='Философия работы')),
                ('philosophy_tg', models.TextField(blank=True, help_text='Краткое описание подхода к пациентам', null=True, verbose_name='Философия работы')),
