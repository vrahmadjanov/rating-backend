    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(help_text='Город или район, где находится медицинское учреждение', on_delete=django.db.models.deletion.CASCADE, to='a_base.city', verbose_name='Город/Район')),
