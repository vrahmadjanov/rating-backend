    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_degree', models.ForeignKey(blank=True, help_text='Ученая степень врача (если есть)', null=True, on_delete=django.db.models.deletion.SET_NULL, to='doctors.academicdegree', verbose_name='Ученая степень')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(help_text='Город или район, где находится медицинское учреждение', on_delete=django.db.models.deletion.CASCADE, to='map.city', verbose_name='Город/Район')),
                ('region', models.ForeignKey(help_text='Область, в которой находится медицинское учреждение', on_delete=django.db.models.deletion.CASCADE, to='map.region', verbose_name='Область')),
            ],
            options={
