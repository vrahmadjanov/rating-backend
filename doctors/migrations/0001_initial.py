    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medical_institution', models.ForeignKey(help_text='Медицинское учреждение, где работал или работает врач', on_delete=django.db.models.deletion.PROTECT, related_name='workplaces', to='clinics.clinic', verbose_name='Медицинское учреждение')),
            ],
            options={
