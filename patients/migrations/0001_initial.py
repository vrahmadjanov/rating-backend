    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.DecimalField(blank=True, decimal_places=2, help_text='Вес в килограммах', max_digits=5, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))], verbose_name='Вес (кг)')),
                ('height', models.DecimalField(blank=True, decimal_places=2, help_text='Рост в сантиметрах', max_digits=5, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))], verbose_name='Рост (см)')),
                ...
                ('social_status', models.ForeignKey(blank=True, help_text='Социальный статус пациента.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='a_base.socialstatus', verbose_name='Социальный статус')),
